...
import { createSection, updateSection } from "../../../../../services/opeeations/courseDetailsAPI";
...
const CourseBuilderForm = () => {
    ...
    const onSubmit = async (data) => {
        console.log("data inside course builder form: ",data)
        setLoading(true);
        let result;

        if(editSectionName) {
            // we are updating the section name
            ...
            console.log("Create section data: ", result);
        }
    ...
    const handleChangeSectionName = (sectionId, sectionName) => {
        console.log("handle change section name");
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="flex flex-col space-y-2">
                    ...
                    <input
                        id = "sectionName"
                        disabled={loading}
                        placeholder="Add section name to build your course"
