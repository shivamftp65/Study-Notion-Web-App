...
export default function ChipInput({ label, name, placeholder, register, errors, setValue, getValues }) {
    ...
    // Setting up state for managng chips
    ...
    const handleKeyDown = (event) => {
        ...
        if(event.key === "Enter" || event.key === ","){
            ...
            // check if the input exists and is not already in the chips array
            if(chipValue && !chips.includes(chipValue)){
                // Add the chip to array and clear the input
    ...
    const handleDeleteChip = (chipIndex) => {
        // Filter the chips array to remove the chip with given index
