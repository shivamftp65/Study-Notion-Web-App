...
import { sendOtp, singUp } from '../services/opeeations/authAPI'
...
const VerifyEmail = () => {
    ...
    const handleOnSubmit = (e) => {
        ...
        console.log('signupData inside the verify Email', signupData);

        dispatch(singUp(accountType, firstName, lastName, email,password, confirmPassword, otp, navigate));
    }
    return (
